                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-bank"></i></i></div>
                                Savings Management
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="acc.manage.html" class="active">Account Management</a>
                                    <a class="nav-link" href="transac.html">Transaction Management</a>
                                    <a class="nav-link" href="Interest.html">Interest Rates Management</a>
                                    <a class="nav-link" href="Savings.html">Savings Reports</a>
                                </nav>
                            </div>
                            
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePayments" aria-expanded="false" aria-contol="collapsePayments">
                            ...
                            <div class="collapse" id="collapsePayments" aria-labelledby="headingone" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="Payment.Process.html">Payment Processing</a>
                                    <a class="nav-link" href="Payment.sched.html">Payment Schedules</a>
                                    <a class="nav-link" href="Payment.History.html">Payment History</a>
                                </nav>
                            </div>
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseReporting" aria-expanded="false" aria-contol="collapseReporting">
                                <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                                Reporting
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseReporting" aria-labelledby="headingone" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Payment Reports</a>
                                    <a class="nav-link" href="layout-static.html">Custom Reports</a>
                                    <a class="nav-link" href="layout-static.html">Audit Trails</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content" class="bg-dark" style="--bs-bg-opacity: .95;">
                <main>
                            <div class="container-fluid px-4">
                                <h3 class="mt-4 text-light">Accounts Management</h3>
                                <div class="card mb-4">
                                </div>
                                <div class="card mb-4">
